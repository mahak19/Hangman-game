# -*- coding: utf-8 -*-
"""Maham'-Hangman-Game.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1T-vX3Ux_8DVgki5yLnF6qsioOsEI_jE6

##**HANGMAN Game**

#Code with single letter
"""

#code with single word
...
print("Welcome to Hangman Game!") #starting comments before user enters his output
print("Guess the word:")

while True: #display of hidden word with 6 '_ ' with single space between them
    display = ""
    for letter in word:
    ...
    if display == word: #when use guessed the 'secret word'
        print("Awesome! You've guessed the word:", word)
        print("  \U0001f600  \U0001f600   \U0001f600  ") #emoji code :)
        break

    if len(hidden_word) >= max_attempts: #when user reaches the max length of attempts
        print("Game Over! The word was:", word)
        print('HANGED!!!')
        print(' \U0001FAE3 \U0001FAE3 \U0001FAE3 \U0001FAE3 \U0001FAE3')
        break

    guess = input("Enter a letter: ").lower()

    if len(guess) != 1 or not guess.isalpha(): #this function will make sure user only enter alphabets
        print("Please enter a single letter.") #otherwise it wil print this statement
        continue

    if guess in hidden_word: #incase user repeate the letter he already entered before
        print("You've already guessed that letter.")
        continue

    hidden_word.append(guess) #add right letter to hidden word

    if guess not in word:
        print("Wrong guess!!!")
        attempts_left = max_attempts - len(hidden_word)
